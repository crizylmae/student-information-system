...
button_update = PhotoImage(file="update.png")
global button_delete
button_delete = PhotoImage(file="delete.png")
global button_addstudent
button_addstudent = PhotoImage(file="student.png")
global button_cancel
button_cancel = PhotoImage(file="cancel.png")
global add
button_add = PhotoImage(file="add.png")
global save
button_save = PhotoImage(file="save.png")
...
header = Frame(root, height=100, width=500, bg="lightblue")
header.propagate(0)
header.grid(row=0, column=0)
Label(header, text="STUDENT INFORMATION SYSTEM", font = 'Cambria 20 bold', bg="lightblue", fg="white").place(relx=.5, rely=.5, anchor='c')

#Code for a dynamic searchbar
searchFrame = Frame(root)
searchFrame.grid(row=1,column=0,pady=3)
Label(searchFrame, bg="#fbc681", text="SEARCH:", anchor=W, font = 'Cambria 9 bold', fg="white").grid(row=0, column=0)
