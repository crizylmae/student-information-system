...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Cambria", 30))
        label.place(x=230,y=20)

        home = tk.Button(self, text="HOME",font=("Cambria",16,"bold"),bd=0, width = 10, bg="#664229", fg="white", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Cambria",16,"bold"),bd=0, width = 10, bg="#664229", fg="white", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Cambria",16,"bold"),bd=0, width = 13, bg="#664229", fg="white", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Cambria",15,"bold"),bd=0, width = 10, bg="#664229", fg="white", command=iExit)
        students.place(x=1100,y=460)
        students.config(cursor= "hand2")
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Cambria", 40))
        ...
        def tablec():
            conn = sqlite3.connect("badelles_2.db")
            cur = conn.cursor()
        ...
        def add_course():
            if Course_Code.get() == "" or Course_Name.get() == "" : 
                tkinter.messagebox.showinfo("BADELLES", "Fill in the box")
            else:
                conn = sqlite3.connect("badelles_2.db")
                c = conn.cursor()         
                ...
                Course_Code.set('')
                Course_Name.set('') 
                tkinter.messagebox.showinfo("BADELLES", "Added!")
                display_course()
        ...
        def update_course():
            for selected in self.course_list.selection():
                ...
                conn.commit()
                tkinter.messagebox.showinfo("BADELLES", "Updated!")
                display_course()
                clear()
                conn.close()
        ...
        def edit_course():
            ...
            if x == "":
                tkinter.messagebox.showerror("BADELLES", "Select a course!")
                return
        ...
        def delete_course(): 
            try:
                messageDelete = tkinter.messagebox.askyesno("BADELLES", "Delete this record?")
                if messageDelete > 0:   
                    con = sqlite3.connect("badelles_2.db")
                    cur = con.cursor()
                    ...
                    tkinter.messagebox.showinfo("BADELLES", "Deleted!")
                    display_course()
                    con.close()                    
            except:
                tkinter.messagebox.showerror("BADELLES", "This course has students!")
        ...
        home = tk.Button(self, text="HOME",font=("Cambria",13,"bold"),bd=0, width = 10, bg="#664229", fg="white", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblccode = Label(self, font=("Cambria", 12, "bold"), text="Course Code:", padx=5, pady=5)
        self.lblccode.place(x=125,y=144)
        self.txtccode = Entry(self, font=("Cambria", 13), textvariable=Course_Code, width=31)
        self.txtccode.place(x=270,y=150)

        self.lblcname = Label(self, font=("Cambria", 12,"bold"), text="Course Name:", padx=5, pady=5)
        self.lblcname.place(x=125,y=205)
        self.txtcname = Entry(self, font=("Cambria", 13), textvariable=Course_Name, width=31)
        self.txtcname.place(x=270,y=210)
        
        self.SearchBar = Entry(self, font=("Cambria", 11), textvariable=SearchBar_Var, bd=0,bg="#B99976",width=31)
        ...
        self.adds = Button(self, text="ADD", font=('Cambria', 11, ), height=1, width=10, bd=1, bg="#664229", fg="white",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Cambria', 11), height=1, width=10, bd=1, bg="#664229", fg="white", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Cambria', 11), height=1, width=10, bd=1, bg="#664229", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Cambria', 11), height=1, width=10, bd=1, bg="#664229", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Cambria', 11, 'bold'),bd=0, bg= "#664229", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Cambria', 11, 'bold'), height=1, width=11, bg="#664229", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Cambria", 40))
        label.place(x=130,y=20)
        
        home = tk.Button(self, text="HOME",font=("Cambria",12,"bold"),bd=0, width = 7, bg="#664229", fg="white",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        def add_stud():
            if Student_ID.get() == "" or Student_Name.get() == "" or Course_Code.get() == "" or Student_YearLevel.get() == "" or Student_Gender.get() == "": 
                ...
                if len(a[0]) == 4:        
                    if "-" in ID_list:
                        if len(a[1]) == 1:
                            tkinter.messagebox.showerror("BADELLES", "ID Format:YYYY-NNNN")
                        elif len(a[1]) ==2:
                            tkinter.messagebox.showerror("BADELLES", "ID Format:YYYY-NNNN")
                        elif len(a[1]) ==3:
                            tkinter.messagebox.showerror("BADELLES", "ID Format:YYYY-NNNN")
                            ...
                            if year.isdigit()==False or number.isdigit()==False:
                                try:
                                    tkinter.messagebox.showerror("BADELLES", "Invalid ID")
                                except:
                                    pass
                            elif year==" " or number==" ":
                                try:
                                ...
                                try:
                                    ...
                                    for row in rows:
                                        ids.append(row[0])
                                    if ID in ids:
                                       tkinter.messagebox.showerror("BADELLES", "ID already exists")
                                    else: 
                                       tkinter.messagebox.showerror("BADELLES", "Course Unavailable")
        ...
        def update_stud():
            if Student_ID.get() == "" or Student_Name.get() == "" or Course_Code.get() == "" or Student_YearLevel.get() == "" or Student_Gender.get() == "": 
                tkinter.messagebox.showinfo("BADELLES", "Select a student")
            else:
        ...
        def delete_stud():   
            try:
                messageDelete = tkinter.messagebox.askyesno("BADELLES", "Are you sure you want to permanently remove this?")
                if messageDelete > 0:   
                    con = sqlite3.connect("badelles_2.db")
                    cur = con.cursor()
        ...
        def edit_stud():
            ...
            if x == "":
                tkinter.messagebox.showerror("BADELLES", "Select a record")
                return
        ...
        self.lblid = Label(self, font=("Cambria", 12,"bold"), text="ID Number:", padx=5, pady=5)
        self.lblid.place(x=125,y=144)
        self.txtid = Entry(self, font=("Cambria", 13), textvariable=Student_ID, width=33)
        self.txtid.place(x=255,y=150)

        self.lblname = Label(self, font=("Cambria", 12,"bold"), text="Name:", padx=5, pady=5)
        self.lblname.place(x=125,y=205)
        self.txtname = Entry(self, font=("Cambria", 13), textvariable=Student_Name, width=33)
        self.txtname.place(x=255,y=210)
        
        self.lblc = Label(self, font=("Cambria", 12,"bold"), text="Course Code:", padx=5, pady=5)
        self.lblc.place(x=125,y=269)
        self.txtyear = ttk.Combobox(self, value=["BS STAT", "BS MATH", "BS IT", "BSCS","BSA","BS Bio","BS Chem","BSCE","BSHM","BS Micr","BSN","BA Hist","BAPhil","BA PoSc"], state="readonly", font=("Cambria", 12), textvariable=Course_Code, width=28)
        self.txtyear.place(x=255,y=274)
        

        self.lblyear = Label(self, font=("Cambria", 12,"bold"), text="Year Level:", padx=5, pady=5)
        self.lblyear.place(x=125,y=315)
        self.txtyear = ttk.Combobox(self, value=["1st Year", "2nd Year", "3rd Year", "4th Year"], state="readonly", font=("Cambria", 13), textvariable=Student_YearLevel, width=31)
        self.txtyear.place(x=255,y=320)
        
        self.lblgender = Label(self, font=("Cambria", 13,"bold"), text="Gender:", padx=5, pady=5)
        self.lblgender.place(x=125,y=361)
        self.txtgender = ttk.Combobox(self, value=["Male", "Female"], font=("Cambria", 13), state="readonly", textvariable=Student_Gender, width=28)
        ...
        self.add = Button(self, text="REGISTER", font=('Cambria', 11), height=1, width=10, bd=1,  bg="#664229", fg="white", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Cambria', 11), height=1, width=10, bd=1, bg="#664229", fg="white", command=update_stud)
        ...
        self.delete = Button(self, text="DELETE", font=('Cambria', 11), height=1, width=10, bd=1, bg="#664229", fg="white", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Cambria', 11, 'bold'),bd=0, bg= '#664229', fg="white", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Cambria', 11, 'bold'), height=1, width=11,  bg="#664229", fg="white",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
