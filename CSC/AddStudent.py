...
class AddStudentFrame:
    def __init__(self, frame, table):
        ...
        self.add_id_entry = Entry(self.add_frame, textvariable=self.id_no, highlightthickness=2,
                                  highlightbackground="#885E4B", font=("Cambria", 20))
        self.add_year_combo = ttk.Combobox(self.add_frame, textvariable=self.year, font=("Cambria", 20),
                                           values=[
                                               "1st Year",
                                               "2nd Year",
                                               "3rd Year",
        ...
        self.add_course_entry = Entry(self.add_frame, textvariable=self.course, highlightthickness=2,
                                      highlightbackground="#885E4B", font=("Cambria", 18))
        self.add_gender_combo = ttk.Combobox(self.add_frame, textvariable=self.gender, font=("Cambria", 20),
        ...
        name_label = Label(self.add_frame, text="Name:", font=("Cambria", 20), bg="#885E4B", fg="white")
        name_label.place(x=20, y=50, width=90, height=40)
        self.add_name_entry.place(x=110, y=50, width=270, height=40)
        id_no_label = Label(self.add_frame, text="ID No.:", font=("Cambria", 20), bg="#885E4B", fg="white")
        id_no_label.place(x=20, y=120, width=90, height=40)
        name_format = Label(self.add_frame, text="Last Name, First Name, M.I", font=("Cambria", 10), fg="#885E4B",
                            bg="white")
        name_format.place(x=115, y=91, height=20)
        self.add_id_entry.place(x=110, y=120, width=270, height=40)
        year_label = Label(self.add_frame, text="Year:", font=("Cambria", 20), bg="#885E4B", fg="white")
        year_label.place(x=20, y=170, width=90, height=40)
        self.add_year_combo.place(x=110, y=170, width=270, height=40)
        course_label = Label(self.add_frame, text="Course:", font=("Cambria", 20), bg="#885E4B", fg="white")
        course_label.place(x=20, y=220, width=90, height=40)
        self.add_course_entry.place(x=110, y=220, width=270, height=40)
        gender_label = Label(self.add_frame, text="Gender:", font=("Cambria", 20), bg="#885E4B", fg="white")
        ...
        add_info_button = Button(self.add_frame, command=self.add_student, text="Add", bg="#885E4B", fg="white",
                                 font=("Cambria", 20))
        add_info_button.place(x=170, y=340, width=90, height=30)
        clear_info_button = Button(self.add_frame, command=self.clear_data, text="Clear", bg="#885E4B", fg="white",
                                   font=("Cambria", 20))
