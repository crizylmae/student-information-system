...
class DeleteStudentFrame:
    def __init__(self, frame, table):
        ...
        self.del_stud_name = Label(self.delete_frame, fg="black", bg="white", highlightthickness=2,
                                    highlightbackground="#885E4B", font=("Cambria", 16), anchor='w')
        ...
        self.del_stud_course = Label(self.delete_frame, fg="black", bg="white",highlightthickness=2,
                                    highlightbackground="#885E4B", font=("Cambria", 16),
                                     anchor='w')
        ...
        choose_lbl = Label(self.delete_frame, text="Select Student to Delete", anchor='w', fg="#885E4B", bg="white",
                           font=("Cambria", 14))
        ...
        name_label = Label(self.delete_frame, text="Name:", font=("Cambria", 20), bg="#885E4B", fg="white")
        name_label.place(x=20, y=80, width=90, height=40)
        id_no_label = Label(self.delete_frame, text="ID No.:", font=("Cambria", 20), bg="#885E4B", fg="white")
        id_no_label.place(x=20, y=130, width=90, height=40)
        year_label = Label(self.delete_frame, text="Year:", font=("Cambria", 20), bg="#885E4B", fg="white")
        year_label.place(x=20, y=180, width=90, height=40)
        course_label = Label(self.delete_frame, text="Course:", font=("Cambria", 20), bg="#885E4B", fg="white")
        course_label.place(x=20, y=230, width=90, height=40)
        gender_label = Label(self.delete_frame, text="Gender:", font=("Cambria", 20), bg="#885E4B", fg="white")
        gender_label.place(x=20, y=280, width=90, height=40)

        delete_button = Button(self.delete_frame, command=self.delete_student, text="Delete", bg="#885E4B", fg="white",
                               font=("Cambria", 20))
