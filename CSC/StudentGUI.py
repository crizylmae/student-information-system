...
class StudentGUI:
    def __init__(self, frame):
        ...
        self.bg_box = Label(self.left_frame, bg="#CEB9A5", highlightbackground="#885E4B", highlightthickness=2)
        self.bg_box.place(x=25, y=145, width=400, height=390)
        self.fg_box = Frame(self.left_frame, bg="#CEB9A5", highlightbackground="#885E4B", highlightthickness=2)
        ...
        self.heading_label = Label(self.left_frame, bg="#885E4B", fg="white", anchor='sw', font=("Bebas Neue", 24))
    ...
    def homepage(self):
        ...
        self.sis_label.config(font=("Bebas Neue", 50), fg="White", borderwidth=2, highlightcolor="Black")
    ...
    def display_attributes(self):
        self.sis_label.config(font=("Bebas Neue", 30), fg="white")
