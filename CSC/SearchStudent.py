...
class SearchStudentFrame:
    def __init__(self, frame):
        ...
        # Search
        self.search_bar_entry = Entry(self.search_frame, highlightthickness=2, highlightbackground="#885E4B",
                                      font=("Cambria", 18))
        self.srch_btn_img = PhotoImage(file=r"search_button_img.png")
        self.srch_result_msg = Label(self.search_frame, text="", bg="white", fg="#885E4B", font=("Cambria", 12))
        ...
        self.srchrslts_label = Label(self.search_frame, text="  Search Result", anchor='w', bg="#885E4B", fg="white",
                                     font=("Cambria", 18))

        self.search_frame.place(x=20, y=120, width=400, height=410)
        id_no_label = Label(self.search_frame, text="ID #", bg="#885E4B", fg="white", font=("Cambria", 20))
        ...
        search_button = Button(self.search_frame, command=self.search_student,
                               image=self.srch_btn_img, bg="#885E4B", fg="white", font=("Cambria", 20))
